...
export class CreateHttpErrorAction extends CrossCuttingActionBase {
  constructor(
      private errorName: string) {
    super();
    this.actionName = 'CreateHttpErrorAction';
  }
  ...
  performAction() {
    ...
    this.response = this.businessProvider.apiService.createHttpError(this.errorName);;
  }
}
