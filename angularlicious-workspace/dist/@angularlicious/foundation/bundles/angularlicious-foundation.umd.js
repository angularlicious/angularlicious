(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angularlicious/actions'), require('@angular/router'), require('@angularlicious/rules-engine'), require('@angular/core'), require('@angular/common/http'), require('rxjs'), require('@angularlicious/logging')) :
    typeof define === 'function' && define.amd ? define('@angularlicious/foundation', ['exports', '@angular/common', '@angularlicious/actions', '@angular/router', '@angularlicious/rules-engine', '@angular/core', '@angular/common/http', 'rxjs', '@angularlicious/logging'], factory) :
    (factory((global.angularlicious = global.angularlicious || {}, global.angularlicious.foundation = {}),global.ng.common,global.actions,global.ng.router,global.rulesEngine,global.ng.core,global.ng.common.http,global.rxjs,global.logging));
}(this, (function (exports,common,actions,router,rulesEngine,core,http,rxjs,logging) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */ ServiceBase = /** @class */ (function () {
         ...
         */
            function (error) {
                /** @type {?} */
                var message = new rulesEngine.ServiceMessage(error.name, error.message)
            ...
            function (error, requestOptions) {
                ...
                if (error && error._body) {
                    try {
                        ...
                        /** @type {?} */
                        var behaviorSubject = new rxjs.BehaviorSubject(errorResponse);
     ...
     */ ActionBase = /** @class */ (function (_super) {
         ...
         */
            function (ruleResult) {
                /** @type {?} */
                var serviceMessage = new rulesEngine.ServiceMessage(ruleResult.rulePolicy.name, ruleResult.rulePolicy.message, rulesEngine.MessageType.Error);
...
//# sourceMappingURL=angularlicious-foundation.umd.js.map